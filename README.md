...
**Domain:** `Legal / Contract Review` · **Suite:** `Legal & Compliance Suite` · **Accent:** `#c084fc`
...
|---|---:|:---:|---|---|
| `contract`<br>Contract | text | Yes | — | Affects input: Contract. |
...
| `contract_type`<br>contract type | text | No | — | Affects customization: contract type. |
...
| `materiality_threshold`<br>materiality threshold | slider | No | 50 | Affects customization: materiality threshold. |
| `preferred_terms`<br>preferred terms | text | No | — | Affects customization: preferred terms. |
| `legal_language_level`<br>legal language level | select | No | English | Affects customization: legal language level. |
